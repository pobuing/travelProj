    ...
    <div class="prosum_box">
        <dl class="prosum_left">
            ...
            <dd>
                ...
                <c:forEach items="${route.routeImgList}" var="img" varStatus="status">
                    ...
                    <c:if test="${status.count>4}">
                        <a title="" class="little_img" data-bigpic="${img.bigPic}" style="display: none">
                            <img src="${img.smallPic}">
                        </a>
                    </c:if>
                </c:forEach>
        ...
        <div class="prosum_right">
            ...
            <div class="pros_other">
                <p>${route.seller.sname}</p>
                <p>${route.seller.consphone}</p>
                <p>${route.seller.address}</p>
            </div>
